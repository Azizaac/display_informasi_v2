...
--
-- Host: localhost    Database: display_informasi_v2
-- ------------------------------------------------------
...
CREATE TABLE `background_images` (
  ...
  `position` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'center',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `background_images_is_active_index` (`is_active`)
...
CREATE TABLE `carousels` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `carousels_order_index_index` (`order_index`),
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2024_01_01_000001_create_jadwals_table',1),(5,'2024_01_01_000002_create_carousels_table',1),(6,'2024_01_01_000003_create_videos_table',1),(7,'2024_01_01_000004_create_background_images_table',1),(8,'2024_01_01_000005_create_informasis_table',1);
...
INSERT INTO `sessions` VALUES ('eK1mvVJu3b3XvVIs3kzTGh4xBKPwzOwnC8ZFmXAF',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','',1768879842);
...
-- Dump completed on 2026-01-20 10:31:51
