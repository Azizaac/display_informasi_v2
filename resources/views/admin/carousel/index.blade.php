    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.carousel.create') }}" class="btn btn-light btn-sm">+ Tambah Carousel</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <img src="{{ $url }}" alt="Carousel" style="max-height: 60px; max-width: 100px; border-radius: 4px;">
                                </td>
                                <td>{{ $item->caption ?? '-' }}</td>
                ...
                <div class="alert alert-info text-center" role="alert">
                    <p class="mb-0">Belum ada carousel. <a href="{{ route('admin.carousel.create') }}">Tambah carousel sekarang</a></p>
                </div>
                @endif
            </div>
        </div>
